...
@section('content')
    <div class="container">
        ...
        <h3 class="text-primary my-3">Edit post</h3>
        <form action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" name="image" class="custom-input form-control" value="{{$post->image}}">
                    @error('image')
                        <span class="text-danger mt-1">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group mb-3">
                    ...
                    <textarea name="content" id="" rows="10" class="form-control" placeholder="What's on your mind ...">{{$post->content}}</textarea>
                    @error('content')
